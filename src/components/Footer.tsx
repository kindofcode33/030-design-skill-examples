        ...
        <div className="max-w-asu-content mx-auto px-asu-3 h-full flex items-center justify-between">
          ...
          <nav aria-label="Social Media" className="flex items-center gap-asu-3">
            <a
              href="#"
              aria-label="Facebook"
              className="w-10 h-10 flex items-center justify-center bg-asu-gray-2 hover:bg-white/20 transition-colors"
            >
      ...
      <div className="bg-asu-gold h-[100px]">
        <div className="max-w-asu-content mx-auto px-asu-3 h-full flex items-center justify-between">
          <nav
            ...
            className="flex items-center gap-asu-2 flex-wrap"
          >
            <a
              href="#"
              className="text-asu-body text-asu-gray-1 font-bold no-underline hover:[text-decoration:underline]"
            >
              Maps and Locations
            </a>
            <a
      ...
      <div className="bg-asu-gray-6 h-14">
        <div className="max-w-asu-content mx-auto px-asu-3 h-full flex items-center">
          ...
          >
            <a
              href="#"
              className="text-asu-body-sm text-asu-gray-2 no-underline hover:[text-decoration:underline]"
            >
            ...
            <button className="text-asu-body-sm text-asu-gray-2 bg-transparent border-none cursor-pointer p-0 hover:[text-decoration:underline]">
